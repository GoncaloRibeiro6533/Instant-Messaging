...
class InvitationController(private val invitationService: InvitationService) {
    ...
    fun createChannelInvitation(
        ...
        val result = invitationInputModel.channelId?.let {
    ...
    fun createRegisterInvitation(
        ...
        val result = invitationInputModel.email?.let {
    ...
    fun acceptRegisterInvitation(
        ...
        val result = invitationService.acceptChannelInvitation(
            invitationId,
            token
        )
    ...
    fun getInvitations(
        ...
        val result = invitationService.getInvitationsOfUser(
            userId,
            token
        )
    ...
    fun getChannelInvitations(
        ...
        val result = invitationService.getRegisterInvitationById(
            invitationId
        )

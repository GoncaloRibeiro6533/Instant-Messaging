...
class ChannelRepoMockTests {
    ...
    fun `Test get channels of user`() {
        ...
        repoChannels.joinChannel(user, channel1, Role.READ_WRITE)
    ...
    fun `Test get channel members`() {
        ...
        repoChannels.joinChannel(user, channel1, Role.READ_WRITE)
        repoChannels.joinChannel(user1, channel1, Role.READ_WRITE)
    ...
    fun `Test add user to channel`() {
        ...
        repoChannels.joinChannel(user, channel, Role.READ_WRITE)
